...
public class FloatingTextTag : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        textTag = this.GetComponentInChildren<TextMeshProUGUI>();
        textTag.text = vehicle.GetComponent<MetaData>().GetId().ToString();

...
public class coordinateBasedMovementHM2L1 : MonoBehaviour
{
    ...
    float carLength = 1.52f;
     ...
     float[][] coordinates = {
    new float[] {37.8f, 140.7f, -2.094f},
    new float[] {35.51f, 139.08f, -2.094f},
    new float[] {33.22f, 137.46f, -2.094f},
    new float[] {30.93f, 135.84f, -2.094f},
    new float[] {28.64f, 134.22f, -2.094f},
    new float[] {26.35f, 132.6f, -2.094f},
    new float[] {24.06f, 130.98f, -2.094f},
    new float[] {21.77f, 129.36f, -2.094f},
    new float[] {19.48f, 127.74f, -2.094f},
    new float[] {17.19f, 126.12f, -2.618f},
    new float[] {17.02f, 119.92f, -3.24f},
    new float[] {15.87f, 110.66f, -2.818f},
    new float[] {15.22f, 104.63f, -2.818f},
    new float[] {13.04f, 95.56f, -2.818f},
    new float[] {10.86f, 86.49f, -2.818f},
    new float[] {8.68f, 77.42f, -2.818f},
    new float[] {6.5f, 68.35f, -2.818f},
    new float[] {4.32f, 59.28f, -2.818f},
    new float[] {2.14f, 50.21f, -2.818f},
    new float[] {-0.04f, 41.14f, -2.818f},
    new float[] {-2.22f, 32.07f, -3.24f},
    new float[] {-3.82f, 21.3f, -3.24f},
    new float[] {-2.08f, 16.2f, -3.24f},
    new float[] {-1.5f, 14.5f, -3.24f},
    new float[] {0.24f, 9.4f, -3.24f},
    new float[] {0.82f, 7.7f, -3.24f},
    new float[] {1.4f, 6.0f, -3.24f}
};
    ...
    public void MoveObjectToPosition(float xPosition, float zPosition, float angleInRadians)
    {
        ...
        int layerMask = LayerMask.GetMask("MiningEnvL1");

...
namespace MCSData.Communication
{
    ...
    public class DRFConnection : MonoBehaviour
    {
       ...
       // private readonly ILogger<DRFConnection> logger;
        ...
        // public event EventHandler<ServerMessageEventArgs> PublishMessage;

        // public DRFConnection(ILogger<DRFConnection> logger)
        // {
        //     this.logger = logger;
        ...
        // void MessagePublished(string msg)
        // {
        //     var handler = PublishMessage;
        //     if (handler != null)
        //     {
        //         handler(this, new ServerMessageEventArgs(msg));
        //     }
        // }
        ...
        // public TReturn Call<TReturn>(string procedureToCall, Object[] Arg4G2)
        // {
        //     return Call<TReturn>(procedureToCall, true, Arg4G2);
        // }
        ...
        // public Task<object> CallAsync(string procedureToCall, Object[] Arg4G2)
        // {
        //     return CallAsync<object>(procedureToCall, true, Arg4G2);
        // }
        ...
        // public void Start(string procedureToStart, params object[] Arg4G2)
        // {
        //     if (m_gateWay is null || m_gateWay.IPCInterfaceStatus == (int)LinkStatus.Inactive)
        //     {
        //         throw new InvalidOperationException("Unable to execute call. No active connection exists");
        ...
        //     m_gateWay.Start(procedureToStart, Arg4G2);
        // }
        ...
        // private T DisposeCOMComponent<T>(T comObject)
        // {
        //     if (comObject == null) return comObject;
        //     if (comObject is IDisposable)
        //     {
        //         ((IDisposable)comObject).Dispose();
        //     }
        //     if (Marshal.IsComObject(comObject) && OperatingSystem.IsWindows())
        //     {
        ...
        //         try
        //         {
        //             logger?.LogInformation("Disconnecting DRF connection on dispose");
        //             this.Disconnect();
        //         }
        //         catch (Exception e)
        //         {
        //             logger?.LogWarning("Unable to disconnect DRF before disposing", e);
        //         }
        //     }

        //     logger?.LogInformation("Disposing DRF connection");
        //     try
        //     {
        //         DisposeCOMComponent(m_gateWay);
        //         logger?.LogInformation("DRF connection has been disposed");
        //     }
        //     catch (Exception e)
        //     {
        //         logger?.LogError("An error occured when disposing DRF connection", e);
        //         try
        //         {
        //             DisposeCOMComponent(m_gateWay);
        //         }
